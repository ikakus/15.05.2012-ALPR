...
namespace myALPR1
{
    public partial class CapturedPlatesLog : Form
    {
        public CapturedPlatesLog(LicensePlatesDBConnectionClass Db)
        {
            InitializeComponent();
        ...
        public void AddToListbox(ListViewItem itm)
        {
            if (this.listView1.InvokeRequired)
                this.listView1.Invoke(new QuerryListAdd(AddToListbox), new object[] { itm });
            else
            {
        ...
        public void fillScheduleGrid()
        {
           ...
           // con.Open();
            ...
            while (myReader.Read())
            {
                ...
                str[1] = myReader["DateTime"].ToString();
                str[2] = myReader["LicensePlate"].ToString();
        ...
        public void RemoveSelected()
        {
            for (int i = 0; i < listView1.Items.Count; i++)
            {
                ...
                {
                    DatabaseConnector.DeleteByIDFromLog(Convert.ToInt32(listView1.Items[i].SubItems[0].Text));
        ...
        private void listView1_ItemSelectionChanged(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count >0)
            {
                ...
                pictureBox1.Image = DatabaseConnector.GetPictureFromBaase(Convert.ToInt32(itm.SubItems[0].Text));

                label1.Text = itm.SubItems[2].Text;
            }
        }
